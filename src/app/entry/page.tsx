    ...
    >
      ...
      >
        ...
        <div className="text-ink-text/80 font-body text-xs sm:text-sm leading-relaxed space-y-3 sm:space-y-4">
          ...
          <h3 className={h3Class}>第4条（メールアドレスの利用・特定電子メール）</h3>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>運営者および提携パートナー企業からの広告・キャンペーン・お得な情報・商品紹介等の商用メール（広告宣伝メール）の送信</li>
          ...
          <h3 className={h3Class}>第5条（ユーザー情報の商用利用に関する同意）</h3>
          <p>1. ユーザーは、本規約への同意をもって、ユーザー情報が以下の目的で商用利用されることに同意します。</p>
          <ul className="list-disc pl-5 space-y-1">
            <li>マーケティング分析およびターゲティング広告の企画・配信</li>
            <li>提携企業・パートナーへの統計データ（個人を特定しない匿名化・集計済み形式）の提供</li>
            <li>本サービスおよび運営者が運営する関連サービスの宣伝・プロモーション活動</li>
            <li>ユーザーの属性・診断結果に基づいたパーソナライズされたコンテンツ・広告・商品推薦の提供</li>
            <li>市場調査・学術研究目的での匿名化データの利用</li>
          </ul>
          <p>2. 個人を直接特定可能な形でのユーザー情報の第三者への販売・譲渡は行いません。</p>
      ...
      >
        ...
        <div className="text-ink-text/80 font-body text-xs sm:text-sm leading-relaxed space-y-3 sm:space-y-4">
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li><strong>運営者および提携パートナー企業からの広告・プロモーション・キャンペーン・商品紹介等の商用メール（広告宣伝メール）の送信（特定電子メールの送信の適正化等に関する法律に基づく）</strong></li>
            <li>マーケティング調査・統計分析（個人を特定しない匿名化・集計形式での利用を含む）</li>
